...
import { Paper, Stack, Box, Slider, Fab, IconButton, Typography } from '@mui/material';
...
const PlayerContainer = () => {
  ...
  useEffect(() => {
    setPlayTime(0);
    if (appState?.currently_playing.albumId ) {
    ...
    <Paper sx={{ position: 'fixed', bottom: 0, left: 0, right: 0, width: "100vw", zIndex: 1300 }} elevation={12}>
      ...
      <Stack direction="row" sx={{ pb: 2, pl: 2, pr: 4 }} spacing={2} justifyContent="space-between" alignItems="center">
        ...
        <Stack direction="row" alignItems="center" spacing={2}>
          ...
          <Typography variant="h6">{appState.currently_playing.name}</Typography>
        </Stack>
